...
NSString *const PIErrorDomain = @"org.oblador.react-native-vector-icons";

@implementation PierreIcons
                                ...
                                withError:(NSError **)error
{
  ...
  if (!success) {
    *error = [NSError errorWithDomain:PIErrorDomain code:PIGenericError userInfo:@{NSLocalizedDescriptionKey: @"Failed to write rendered icon image"}];
    return nil;
  }
  return filePath;
}
